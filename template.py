'''Role of template.py : It is just like a Template of the project (how project looks like) 
It Automatically Creates all the list of packages , files by writing a script of code'''
